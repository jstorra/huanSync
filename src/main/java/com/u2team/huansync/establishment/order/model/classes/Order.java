...
public class Order {
    ...
    //Constructor
    public Order(long orderId, int customerId, int establishmentId, int cashId, int cashierOperatorId, OrderStatusEnum orderStatusEnum) {
    ...
    public OrderStatusEnum getOrderStatusEnum(String orderStatus) {
        ...
        if(orderStatus.equalsIgnoreCase("REGISTERED")){
            orderStatusEnum = OrderStatusEnum.REGISTERED;
        }
