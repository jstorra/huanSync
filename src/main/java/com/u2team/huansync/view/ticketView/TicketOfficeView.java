...
public class TicketOfficeView extends javax.swing.JFrame {
    ...
    private boolean validateFields() {
        if (txtNameTicket.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "You must complete all fields", "Validation error",
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 159,
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(jLabel3)
                                        .addComponent(jLabel10)
                                        .addComponent(txtNumberEvent, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (txtName.getText().trim().isEmpty() || txtDocument.getText().trim().isEmpty()
                    || txtGender.getText().trim().isEmpty()
                    || txtDate.getText().trim().isEmpty() || txtEmail.getText().trim().isEmpty()
                    || txtNumber.getText().trim().isEmpty() || txtNumberEvent.getText().trim().isEmpty()
                    || txtContactNumber.getText().trim().isEmpty() || txtAddress.getText().trim().isEmpty()
                    || txtNameTicket.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please, you must complete all fields.", "Validation Error",
                        JOptionPane.ERROR_MESSAGE);
            } else {
                ...
                try {
                    ...
                    if (customers.getCustomerTypeEnum() != null && ticket.getStaffId() != 0) {
                        ...
                        if (tickets.getStatusEnum() != null) {
                            ...
                            JOptionPane.showMessageDialog(this, "Ticket status is not selected.", "Validation Error",
                                    JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        // Handle the case where either customer type or staff is not selected
                        JOptionPane.showMessageDialog(this, "Customer type or staff is not selected.",
                                "Validation Error", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (DateTimeParseException e) {
                    JOptionPane.showMessageDialog(this,
                            "Invalid date format. Please enter the date in the correct format.", "Validation Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketOfficeView.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
